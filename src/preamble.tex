...
\newcommand{\trTargetObject}{타겟 오브젝트} % target object
\newcommand{\trArrow}{애로우} % arrow
\newcommand{\trSourceObject}{소스 오브젝트} % source object
...
\newcommand{\trOperationalSemantics}{수행 의미론} % operational semantics
\newcommand{\trDenotationalSemantics}{표시 의미론} % denotational semantics
