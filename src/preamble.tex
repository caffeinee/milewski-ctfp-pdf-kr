...
\newcommand{\trIdentityFunction}{항등함수} % identity function
...
\newcommand{\trComposability}{합성 가능성} % composability
\newcommand{\trTargetObject}{대상 개체} % target object
\newcommand{\trSourceObject}{원본 개체} % source object
\newcommand{\trTypeInference}{타입 추론} % type inference
\newcommand{\trTypeAnnotation}{타입 어노테이션} % type annotation
\newcommand{\trPolymorphic}{다형적} % polymorphic
\newcommand{\trBottom}{바텀} % bottom
\newcommand{\trSemantics}{의미론} % semantics
\newcommand{\trPartial}{파셜} % partial
\newcommand{\trTotal}{토탈} % total
\newcommand{\trOperationalSemantics}{동작 의미론} % operational semantics
\newcommand{\trDenotationalSemantics}{표기 의미론} % denotational semantics
\newcommand{\trMonad}{모나드} % monad
\newcommand{\trSourceFunction}{원본 함수} % source function
\newcommand{\trTargetFunction}{대상 함수} % target function
\newcommand{\trIsomorphism}{이소모피즘} % isomorphism
\newcommand{\trList}{리스트} % list
\newcommand{\trTarget}{대상} % target
\newcommand{\trPredicates}{술어} % predicates
\newcommand{\trAdder}{가산자} % adder
\newcommand{\trThin}{얇} % $$$$$$$$$$$$$$$$
\newcommand{\trAssociate}{결합} % assiciate
\newcommand{\trExtensional}{확장된} % extensional
\newcommand{\trPreorder}{전위순서집합} % preorder
\newcommand{\trTotalOrder}{전순서집합} % total order
\newcommand{\trPartialOrder}{부분순서집합} % partial order
\newcommand{\trLinearOrder}{선형순서집합} % linear order
\newcommand{\trOrder}{순서} % order
\newcommand{\trHomSet}{사상집합} % hom-set
\newcommand{\trNeutralElement}{중립원소} % neutral element
\newcommand{\trCommutativity}{교환성} % 
\newcommand{\trCurrying}{currying} % currying
\newcommand{\trPointFree}{접독립} % point-free
\newcommand{\trPointWiseEquality}{점별 동등성} % point-wise equality
\newcommand{\trMonoid}{모노이드} % monoid
\newcommand{\trLocallySmall}{국소적으로 작다} % locally small
\newcommand{\trFreeCategory}{자유카테고리} % free category
\newcommand{\trFreeConstruction}{자유구성} % free construction
\newcommand{\trKleisli}{크레이슬리\xspace} % kleisli
\newcommand{\trEmbellish}{장식} % embellish
%
