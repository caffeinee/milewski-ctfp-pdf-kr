...
또한, \trIdentity 함수에 해당하는 0\trAdder도 있음을 관찰할 수 있다.
...
\caption{집합 내의 점과 \trMorphism\로써 보는 \trMonoid\trHomSet}
\end{figure}
...
\item
  AND 연산자에 대한 \code{Bool} \trMonoid\를 \trCategory\로써 표현하시오. 모든 \trMorphism, 각각의 \trComposition 법칙을 나열하시오.
\item
